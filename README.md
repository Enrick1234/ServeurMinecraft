...
Passez ensuite à la [backup](https://github.com/Enrick1234/ServeurMinecraft/blob/main/backup.md) ou au [monitoring](https://github.com/Enrick1234/ServeurMinecraft/blob/main/monitoring.md) de votre serveur. 
